...
public sealed partial class SupermatterGasBarContainer : BoxContainer
{
    ...
    public SupermatterGasBarContainer(Gas gas)
    {
        ...
        // atmos.tickrate is server-only; keep client-side display stable with the default value.
        const float atmosTickRate = 15f;
    ...
    public void UpdateEntry(Gas gas, SupermatterFocusData focusData)
    {
        ...
        var value = totalMoles <= 0f
            ? 0f
            : focusData.GasStorage.GetMoles(gas) / totalMoles * 100f;
