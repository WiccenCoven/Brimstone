...
frontier-lobby-jupiter-description = This does NOT fall under the protection of portstriking rules. A large, stealthy carrier retrofitted and operated by the Phaethon Dynasty Imperial Vanguard. While it is well-armed compared to the rest of the PDV navy, it is exceptionally vulnerable and thus is located in the outer sector.
